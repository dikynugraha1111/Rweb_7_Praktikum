    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
                <img src="assets/img/uad.png" class="img-fluid animated" alt="" width="300px">
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
                    ...
                    <p>Arsip Kita dibangun atas problem yang terjadi di lingkungan sekolah. Dengan adanya permintaan data dari alumni, ataupun perusahaan yang ingin mengetahui jejak data dari alumni TIF UAD..</p>

                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon"><i class="bx bx-fingerprint"></i></div>
                        <h4 class="title"><a href="/Siswa">Temukan Dengan NIM</a></h4>
                        <p class="description">Anda dapat dengan mudah menemukan data dengan inputan NIM</p>
                    </div>
